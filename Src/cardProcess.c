	...
	while(!cardPresent) {
		...
		if (event & SWIPE31) {
			...
			if (check == TRUE) {
				...
				GL_Dialog_Message(gGoalGraphicLibInstance, "Card Details", tcTrk1 , GL_ICON_INFORMATION, GL_BUTTON_NONE, 2*1000);
		...
		if (event & SWIPE2) {
			...
			if (check == TRUE) {
				...
				GL_Dialog_Message(gGoalGraphicLibInstance, "Card Details", tcTrk2 , GL_ICON_INFORMATION, GL_BUTTON_NONE, 2*1000);
		...
		if (event & SWIPE3) {
			...
			if (check == TRUE) {
				...
				GL_Dialog_Message(gGoalGraphicLibInstance, "Card Details", tcTrk3 , GL_ICON_INFORMATION, GL_BUTTON_NONE, 2*1000);
